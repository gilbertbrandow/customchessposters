<template>
    ...
    <svg v-else-if="name === 'close'" height="329pt" viewBox="0 0 329.26933 329" width="329pt" xmlns="http://www.w3.org/2000/svg">
        <path
    ...
    <svg v-else-if="name == 'filter-remove'" id="Layer_1" enable-background="new 0 0 24 24" height="512" viewBox="0 0 24 24"
        width="512" xmlns="http://www.w3.org/2000/svg">
        <g>
            <path
                d="m11 21.4c-.4 0-.7-.1-1.1-.3-.6-.4-.9-1-.9-1.7v-6l-5.4-5.4c-.4-.4-.6-.9-.6-1.4v-1.6c0-1.1.9-2 2-2h2.5c.6 0 1 .4 1 1s-.4 1-1 1h-2.5v1.6l5.4 5.4c.4.4.6.9.6 1.4v6l2-1v-5c0-.5.2-1 .6-1.4l1.2-1.2c.4-.4 1-.4 1.4 0s.4 1 0 1.4l-1.2 1.2v5c0 .8-.4 1.4-1.1 1.8l-2 1c-.3.1-.6.2-.9.2zm7-11.4c-.3 0-.5-.1-.7-.3-.4-.4-.4-1 0-1.4l1.7-1.7v-1.6h-6c-.6 0-1-.4-1-1s.4-1 1-1h6c1.1 0 2 .9 2 2v1.6c0 .5-.2 1-.6 1.4l-1.7 1.7c-.2.2-.4.3-.7.3z" />
        </g>
        <g>
            <path d="m19 16c-.3 0-.5-.1-.7-.3l-14-14c-.4-.4-.4-1 0-1.4s1-.4 1.4 0l14 14c.4.4.4 1 0 1.4-.2.2-.4.3-.7.3z" />
        </g>
    </svg>


    <svg v-else-if="name == 'pause'" fill="none" height="512" viewBox="0 0 24 24" width="512"
        xmlns="http://www.w3.org/2000/svg">
        <path clip-rule="evenodd"
            d="m8 4c.55228 0 1 .44772 1 1v14c0 .5523-.44772 1-1 1s-1-.4477-1-1v-14c0-.55228.44772-1 1-1zm8 0c.5523 0 1 .44772 1 1v14c0 .5523-.4477 1-1 1s-1-.4477-1-1v-14c0-.55228.4477-1 1-1z"
    ...
    <svg v-else-if="name == 'order'" id="Layer_1" enable-background="new 0 0 48 48" height="512" viewBox="0 0 48 48"
        width="512" xmlns="http://www.w3.org/2000/svg">
        <g>
            <g>
                <path
            ...
            <g>
                ...
                <g>
                    <path d="m24 9.4c-1 0-1.8-.8-1.8-1.8v-5.3c0-1 .8-1.8 1.8-1.8s1.8.8 1.8 1.8v5.2c0 1.1-.8 1.9-1.8 1.9z" />
                </g>
                <g>
                    <path
            ...
            <g>
                <g>
                    <path d="m32.4 21.7h-16.8c-1 0-1.8-.8-1.8-1.8s.8-1.8 1.8-1.8h16.9c1 0 1.8.8 1.8 1.8s-.8 1.8-1.9 1.8z" />
                </g>
                <g>
                    <path
