<template>
    <section class="is--pt">
        <div class="container">
            ...
            <br>
            <p>Custom Chess Posters operates the customchessposters.com website, which provides the our users with their
                completely custom posters featuring their game of choice.

                This page is used to inform website visitors regarding our policies with the collection, use, and disclosure
                of Personal Information if anyone decided to use our serivce, the Custom Chess Posters website.
                ...
                accessible at customchessposters.com, unless otherwise defined in this Privacy Policy.</p>
            <br><br>
            ...
            Our website uses these cookies to collection information and to improve our website. You have the option
            to either accept or refuse these cookies, and know when a cookie is being sent to your computer. If you
            choose to refuse our cookies, you may not be able to use some portions of our website. -->
            <br><br>
            ...
            <p> If you have any questions or suggestions about our Privacy Policy, do not hesitate
                <Link :href="route('contact.index')"> to contact us</Link>.
            </p>
        </div>
    </section>
</template>
