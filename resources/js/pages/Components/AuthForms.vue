<template>
    <div class="content slide-out" v-if="(this.$page.props.overlay.login || this.$page.props.overlay.register || this.$page.props.overlay.forgot) && (!Object.keys(this.$page.props.overlay.lightbox).length)">
        <button class="button__rnd-icn" @click="this.$page.props.overlay.visible = false">
            <Icon name="close" />
        </button>
        <div v-if="this.$page.props.overlay.login">
            <h1>Sign in</h1>
        ...
        <div v-else-if="this.$page.props.overlay.register">
            <h1>Register</h1>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros
                elementum
                tristique. </p>
            <form @submit.prevent="submit('register')" class="form">
                ...
                <div class="field__wrp">
                    ...
                    <input v-model="register.password" type="password" class="field"
                        :class="{ 'is--error': register.errors.password }" name="password" placeholder="••••••••"
                        required>
        ...
        <div v-else-if="this.$page.props.overlay.forgot">
